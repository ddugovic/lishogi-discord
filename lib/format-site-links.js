...
function formatGifURL(gameId, theme, piece) {
    return formatThumbnailURL(gameId, theme, piece);
    if (theme && piece) {
        return `https://lichess1.org/game/export/gif/${gameId}.gif?theme=${theme}&piece=${piece}`;
    }
    return `https://lichess1.org/game/export/gif/${gameId}.gif`;
}
