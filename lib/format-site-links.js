...
function formatPositionURL(fen, lastMove) {
    fen = fen.replace(/ /g, '+');
    return lastMove ? `https://lichess1.org/export/fen.gif?fen=${fen}&lastMove=${lastMove}` : `https://lichess1.org/export/fen.gif?fen=${fen}`;
}
