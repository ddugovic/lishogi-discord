...
function formatPositionURL(fen, lastMove, theme) {
    fen = fen.replace(/ /g, '+');
    return lastMove ? `https://lichess1.org/export/fen.gif?fen=${fen}&lastMove=${lastMove}&theme=${theme}` : `https://lichess1.org/export/fen.gif?fen=${fen}&theme=${theme}`;
}
...
module.exports = { formatTitledUserLink, formatArenaLink, formatArenaLinks, formatPositionURL, formatSiteLink, formatSiteLinks, formatTeamLink, formatTeamLinks, formatUserLink, formatUserLinks, formatURI, formatURIs };
