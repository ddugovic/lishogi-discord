function timestamp(event, sente, gote, year, month, day, hour, minute, offset) {
...
async function interact(interaction) {
    ...
    return timestamp(interaction.options.getString('event'), interaction.options.getUser('sente'), interaction.options.getUser('gote'), interaction.options.getInteger('year'), interaction.options.getInteger('month'), interaction.options.getInteger('day'), interaction.options.getInteger('hour'), interaction.options.getInteger('minute'), interaction.options.getInteger('offset'));
}
