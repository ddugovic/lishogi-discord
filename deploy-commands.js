...
const commands = [
    ...
    new SlashCommandBuilder().setName('timestamp').setDescription("Print discord magic timestamp").addIntegerOption(option => option.setName('year').setDescription('Year').setMinValue(1970).setRequired(true)).addIntegerOption(option => option.setName('month').setDescription('Month').setMinValue(1).setMaxValue(12).setRequired(true)).addIntegerOption(option => option.setName('day').setDescription('Day').setMinValue(1).setMaxValue(31).setRequired(true)).addIntegerOption(option => option.setName('hour').setDescription('Hour').setMinValue(0).setMaxValue(23)).addIntegerOption(option => option.setName('minute').setDescription('Minute').setMinValue(0).setMaxValue(59)).addIntegerOption(option => option.setName('second').setDescription('Second').setMinValue(0).setMaxValue(59)).addIntegerOption(option => option.setName('offset').setDescription('UTC offset').setMinValue(-12).setMaxValue(14)),
