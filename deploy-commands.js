...
const commands = [
    ...
    new SlashCommandBuilder().setName('eval').setDescription("Get the cached evaluation of a position, if available").addStringOption(option => option.setName('fen').setDescription('FEN (Forsyth-Edwards Notation)')).addStringOption(option => option.setName('theme').setDescription('Select a board theme').addChoices(...themes)).addStringOption(option => option.setName('piece').setDescription('Select a piece set').addChoices(...pieces)).addIntegerOption(option => option.setName('since').setDescription('Include master games from this year or later').setMinValue(1952)).addIntegerOption(option => option.setName('until').setDescription('Include master games from this year or earlier')),
    ...
    new SlashCommandBuilder().setName('playing').setDescription("Share your (or a user's) current game").addStringOption(option => option.setName('username').setDescription('Enter lichess username').setAutocomplete(true).setMaxLength(30).setMinLength(2)).addStringOption(option => option.setName('theme').setDescription('Select a board theme').addChoices(...themes)).addStringOption(option => option.setName('piece').setDescription('Select a piece set').addChoices(...pieces)),
    new SlashCommandBuilder().setName('privacy').setDescription("View privacy policy"),
    new SlashCommandBuilder().setName('profile').setDescription("Display your (or a user's) profile").addStringOption(option => option.setName('username').setDescription('Enter lichess username').setAutocomplete(true).setMaxLength(30).setMinLength(2)),
    ...
    new SlashCommandBuilder().setName('setuser').setDescription("Set your lichess username").addStringOption(option => option.setName('username').setDescription('Enter your lichess username').setAutocomplete(true).setMaxLength(30).setMinLength(2).setRequired(true)),
