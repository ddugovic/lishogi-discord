...
const commands = [
    ...
    new SlashCommandBuilder().setName('eval').setDescription("Get the cached evaluation of a position, if available").addStringOption(option => option.setName('fen').setDescription('FEN (Forsyth-Edwards Notation)')).addStringOption(option => option.setName('theme').setDescription('Select a board theme').addChoices(...themes)).addStringOption(option => option.setName('piece').setDescription('Select a piece set').addChoices(...pieces).addIntegerOption('since').setDescription('Include master games from this year or later').addIntegerOption('until').setDescription('Include master games from this year or earlier')),
