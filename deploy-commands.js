...
const commands = [
    ...
    new SlashCommandBuilder().setName('gif').setDescription("Share your (or a user's) current game as a GIF").addStringOption(option => option.setName('username').setDescription('Enter playstrategy player username')),
    ...
    new SlashCommandBuilder().setName('setuser').setDescription("Set your playstrategy username").addStringOption(option => option.setName('username').setDescription('Enter your playstrategy username')),
